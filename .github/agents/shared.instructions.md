---
description: "Shared rules for all agents in the MicroStrategy to Power BI migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — MicroStrategy to Power BI Migration
