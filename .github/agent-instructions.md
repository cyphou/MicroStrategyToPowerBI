# Agent Behavior Instructions — MicroStrategy to Power BI Migration
...
- **Pipeline**: MicroStrategy source → [microstrategy_export] → Extraction → [output, powerbi_import, test_output, test_output_nocal] → Power BI
- **Source**: `microstrategy_export/`
- **Target**: `output/`, `powerbi_import/`, `test_output/`, `test_output_nocal/`
- **Tests**: `pytest tests/ --tb=short -q` — 46 test files
